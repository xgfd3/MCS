...
package graduation.mcs.widget.qrcode.camera;
...
public class CameraManager {
    ...
    public synchronized void setTorch(boolean newSetting) {
        ...
        if( theCamera != null ){
            if (newSetting) {
                parameter = theCamera.getParameters();
    ...
    public boolean getTorchState() {
        ...
        if (theCamera != null) {
            Parameters parameters = theCamera.getParameters();
            if (parameters != null) {
                String flashMode = theCamera.getParameters().getFlashMode();
                return flashMode != null
                        && (Parameters.FLASH_MODE_ON.equals(flashMode) || Parameters.FLASH_MODE_TORCH
                                .equals(flashMode));
            }
        }
        return false;
