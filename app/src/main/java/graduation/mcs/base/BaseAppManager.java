...
public class BaseAppManager {
    ...
    public synchronized void addActivity(Activity activity) {
        ...
        Log.e(TAG, "current count of activities after adding: "+ mActivities.size());
        for(Activity a : mActivities){
            Log.e(TAG, "current existing activity: "+ a.toString());
        }
    }
    ...
    public synchronized void removeActivity(Activity activity) {
        ...
        Log.e(TAG, "current count of activities after removing: "+ mActivities.size());
    }
